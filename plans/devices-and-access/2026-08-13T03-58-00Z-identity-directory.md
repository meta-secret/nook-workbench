...
- Estimated authored changed lines: 9,800
...
- Current PR slice and acceptance evidence: Identity directory and singleton migration; Acceptance evidence: Rust tests prove invariants and migration policy, actual-WASM tests prove persisted list/create/select behavior, and complete exact-head validation passes
- PR slices and acceptance evidence:
1. Identity directory and singleton migration; Acceptance evidence: Rust tests prove invariants and migration policy, actual-WASM tests prove persisted list/create/select behavior, and complete exact-head validation passes
2. Identity app-key enrollment; Acceptance evidence: Authorization, replay, expiry, mismatch, and DEK-envelope behavior tests pass
3. Identity management UI; Acceptance evidence: Focused Playwright flows and recorded UI demo cover identity creation, selection, linking, graph, and access-method tabs
