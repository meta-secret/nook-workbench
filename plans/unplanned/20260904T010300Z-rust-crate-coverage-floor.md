...
- Owning modules, packages, or layers: Rust coverage Taskfiles and Docker stages, coverage floor metadata and preflight contracts, nine platform crates, Hive, Lace, and nook-preflight
- Ownership units:
1. Capability: Independently enforce and report a 90 percent line floor for every testable first-party Rust crate and explicitly classify exclusions; Gizmo ID: rust-crate-coverage-floor; Functional owner: SRE; Expertise provider: None; Expertise allowed code paths: None; Expertise allowed test paths: None; Expertise forbidden paths: None; Expertise consumer interfaces: None; Expertise acceptance evidence: None; Capability acceptance evidence: Focused infrastructure contracts pass and hosted coverage reports a separate successful threshold for every enforced crate
...
1. Add the smallest coverage configuration and contract changes needed to enumerate every crate, enforce thresholds independently, and expose all deficits in one hosted run.
