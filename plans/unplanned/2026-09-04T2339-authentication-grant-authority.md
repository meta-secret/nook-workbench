...
1. Gizmo ID: restore-e2e-collection; Gizmo name: Restore authentication E2E; Predecessor Gizmo ID: None; Restore authentication E2E and independent extension session retention; Estimated authored changed lines: 800; Acceptance evidence: Hosted browser and extension E2E plus required PR checks and exact-head security review pass.
