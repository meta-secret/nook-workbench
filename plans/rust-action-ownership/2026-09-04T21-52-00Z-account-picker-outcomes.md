...
started_at: 2026-09-04T21:52:00Z
agent: codex
...
Continue the authorized architecture program by expressing account-picker cleanup phases through distinct data-carrying types. Consume Rust and WASM mutation receivers and return their successor state and typed result; preserve the centralized extension orchestration contract. This supersedes the previous consuming-transition plan to propagate typed completion outcomes and generated evidence through every browser caller.
...
- Return generated typed completion outcomes and accept generated CleanupEvidence at browser callers. Rejected lock and startup cleanup use existing failure paths; a successful import retains its real result and skips refresh when cleanup is rejected.
...
- The TypeScript completion contract now returns its generated typed outcome and accepts generated evidence. Preserve storage and rebind order, overlap behavior, and successful import responses; expose cleanup rejection without claiming an already successful import failed.
...
3. Capability: Synchronous extension handle transfer; Gizmo ID: rust-action-ownership-account-picker; Functional owner: Web development; Expertise provider: None; Expertise allowed code paths: None; Expertise allowed test paths: None; Expertise forbidden paths: None; Expertise consumer interfaces: None; Expertise acceptance evidence: None; Capability acceptance evidence: Real WASM tests cover concurrent initialization, overlaps, and rejected completion; routing tests preserve import results and reject lock or startup cleanup; popup demo remains fail-closed
- Public or cross-module interfaces: Consuming Rust and WASM lifecycle mutations return AccountPickerAuthorizationTransition with typed CleanupTransitionOutcome; CleanupEvidence replaces boolean evidence; TypeScript callers consume generated evidence and completion outcomes
