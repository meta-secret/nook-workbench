...
- Generated and vendored code are not independently rewritten. Infrastructure and agent automation are separate ownership domains; any required changes must be separately assigned.

## Change budget and PR sequence

- Mission controller: Gizmo Prime
- Current Gizmo ID: global-type-safety-refactor
- Estimated authored changed lines: 15000
- Owning modules, packages, or layers: Product Rust platform, WASM boundary, browser TypeScript and Svelte consumers.
- Ownership units:
...
- Current PR estimated authored changed lines: 15000
...
1. Gizmo ID: global-type-safety-refactor; Gizmo name: Product type safety; Predecessor Gizmo ID: None; Broad product type-safety refactoring; Estimated authored changed lines: 15000; Acceptance evidence: Scoped implementation handoffs, formatting evidence, consistent caller migration, and published PR.
...
4. Publish the branch, record outcomes, and create the pull request without requesting reviews or running tests.
