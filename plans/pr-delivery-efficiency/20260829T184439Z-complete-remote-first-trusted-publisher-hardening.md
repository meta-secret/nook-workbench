---
title: Complete remote-first trusted publisher hardening
feature: pr-delivery-efficiency
issue: null
started_at: 2026-08-29T18:44:39Z
agent: codex
...
- Remove persisted checkout credentials, freeze the trusted baseline, reject editor-controlled orchestration changes, stream validation, verify rerun identity, and reserve a bounded validation window.
...
1. Gizmo ID: remote-first-agent-validation; Gizmo name: Remote-first agent validation; Predecessor Gizmo ID: None; Complete remote-first Cortex and trusted automated-publisher enforcement across indexed callers; Estimated authored changed lines: 1900; Acceptance evidence: CI-agent focused tests, Cortex audit, minimal pre-push hygiene, exact-head Cloud review, hosted repository checks, readiness, and merge
