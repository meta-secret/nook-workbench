---
title: Complete remote-first publisher hardening within one-PR ceiling
...
1. Gizmo ID: remote-first-agent-validation; Gizmo name: Remote-first agent validation; Predecessor Gizmo ID: None; Complete remote-first Cortex and trusted automated-publisher enforcement across indexed callers; Estimated authored changed lines: 2000; Acceptance evidence: CI-agent focused tests, Cortex audit, minimal pre-push hygiene, exact-head Cloud review, hosted repository checks, readiness, and merge
